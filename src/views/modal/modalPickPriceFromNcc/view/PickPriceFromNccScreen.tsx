...
import { usePickPriceFromNccViewModel } from '../viewmodal/usePickPriceFromNccViewModel';
    ...
    ({ item, index }: { item: IItemVendorPrice; index: number }) => {
      ...
      return (
        <AppBlockButton
          ...
          <AppText weight="500">
            {item.vendorName} - {moneyFormat(item.price, '.', '')}
          </AppText>
...
export default PickPriceFromNccScreen;
