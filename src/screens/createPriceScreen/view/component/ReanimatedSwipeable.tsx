...
export interface ReanimatedSwipeableRef {
  closeSwipe: () => void;
}
...
const ReanimatedSwipeable = forwardRef<ReanimatedSwipeableRef, Props>(
  ({ children, renderRightActions, onSwipe, simultaneousGesture }, ref) => {
