 ...
 */
export interface ContentNotificationHk {
  id: number;
  title: string;
  body: string;
  read: boolean;
 ...
 */
const ALL_FAKE_NOTIFICATIONS: ContentNotificationHk[] = Array.from(
...
const cache = new Map<string, ContentNotificationHk[]>();
