...
import {UrlPreviewProps, PreviewData} from './types';
import {
  getPreviewDataHelper,
  renderSpecialElementHelper,
} from './utilsUrlPreview';

enum EUrlPreview {
  Title = 'AppUrlPreview.Title',
  Description = 'AppUrlPreview.Description',
  Image = 'AppUrlPreview.Image',
}
...
const AppUrlPreview = Object.assign(UrlPreviewComponent, {
  Title: Title,
